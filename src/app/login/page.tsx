          ...
          <div className="grid grid-cols-2 gap-1.5 p-1 rounded-2xl bg-zinc-100 dark:bg-zinc-800/80 border border-zinc-200 dark:border-zinc-700/80">
            ...
            <div className="py-2 px-2.5 rounded-xl bg-blue-600 text-white shadow-xs flex items-center justify-center gap-2 cursor-default ring-1.5 ring-blue-600">
              ...
              <div className="text-left leading-none space-y-0.5 min-w-0">
                <span className="text-xs font-black block truncate">Dono / Gestor</span>
                <span className="text-[9px] text-blue-100 font-medium block truncate">Painel do Negócio</span>
              </div>
            </div>

            {/* Inactive Card: Área do Cliente */}
            <Link
              href="/cliente/login"
            ...
            >
              <User className="w-4 h-4 text-zinc-400 group-hover:text-blue-600 shrink-0 transition-colors" />
              <div className="text-left leading-none space-y-0.5 min-w-0">
                <span className="text-xs font-bold block group-hover:text-blue-600 truncate">Área do Cliente</span>
                <span className="text-[9px] text-zinc-400 group-hover:text-blue-500 font-medium block truncate">Meus Agendamentos</span>
              </div>
            </Link>
          </div>
        </div>
